# baileys-core : Typescript/Javascript WhatsApp Web API
 
 Baileys does not require Selenium or any other browser to be interface with WhatsApp Web, it does so directly using a **WebSocket**. Not running Selenium or Chromimum saves you like **half a gig** of ram :/ 

 This is the core version of baileys on which 95% projects are developed so you can use this package.
 Just you want to change package name from project files from 

 Real owner[@Adhiraj](/https://github.com/adiwajshing)
 This package owner[@Manish](/https://github.com/manishkumar1601)
 ...
 If you're interested in building a WhatsApp bot, you may wanna check out [WhatsAppInfoBot](https://github.com/manishkumar1601/WhatsAsenaDuplicated).
...
Create and cd to your NPM project directory and then in terminal, write: 
  `npm install baileys-core`

Do note, Please put ```"type": "module"``` in your package.json before start coding

Then import in your code using:
``` ts 
import { WAConnection } from 'baileys-core'
```
...
``` ts
import { WAConnection, ProxyAgent } from 'baileys-core'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from 'baileys-core'
...
- **MessageOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from 'baileys-core'
                                */
...
``` ts
import { Presence } from 'baileys-core'
...
``` ts
import { MessageType } from 'baileys-core'
...
- To change group settings
    ``` ts
    import { GroupSettingChange } from 'baileys-core'
...
### Note
 This library was originally a project for building just whatsapp automation and bots and is in no way affiliated with WhatsApp. Use at your own discretion. Do not spam people with this.
